...
| `leverage` | Perps only — exchange leverage used for order notional, margin drawdown, and HL `update_leverage` (#497/#518). | 1 |
| `sizing_leverage` | Perps only — margin allocation multiplier. Order notional is `cash * sizing_leverage * leverage`, so `0.1` uses 10% of cash as margin before exchange leverage is applied (#518). | 1 |
