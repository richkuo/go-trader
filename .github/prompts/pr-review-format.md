...
### Create Follow-up Issue is reserved for findings that are separate from the original issue or PR scope — only when the finding stands apart from the work under review; if it belongs to the current scope, put it in another section instead.
