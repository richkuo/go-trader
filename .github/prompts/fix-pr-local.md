...
The Phase 4 no-execution ban covers backtests as well: do NOT run backtests, optimizers, tuning runs, or parity harnesses. CI runs the Go build, go test, and pytest on the pull request separately.
