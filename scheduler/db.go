...
func (sdb *StateDB) migrateSchema() error {
	...
	migrations := []string{
		...
		// #1159: persisted ownership and confirmed-primary watermark for inverse
		// hedge legs. Both are additive so old state databases remain loadable.
