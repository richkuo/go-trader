...
func (sdb *StateDB) migrateSchema() error {
	...
	migrations := []string{
		...
		// #1159: correlated hedge legs. hedge_for is the primary symbol this
		// position hedges (ownership recovered from THIS stamp at startup,
		// never coin-to-symbol inference); hedge_primary_qty_basis is the
		// primary-qty watermark hedge sync diffs against.
