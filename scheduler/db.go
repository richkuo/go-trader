...
func (sdb *StateDB) migrateSchema() error {
	...
	migrations := []string{
		...
		// #1159 persisted hedge ownership and quantity-event watermark. These
		// fields are the restart/reconcile source of truth; coin inference is
		// deliberately forbidden for hedge legs.
