...
type KillSwitchCloseInputs struct {
	...
	// HLHedgeCoins maps hedge coin → "a virtual hedge leg is currently held"
	// (#1159). Only held hedge coins join the kill-switch close roster; a
	// declared-but-flat hedge coin must never liquidate a foreign position.
