...
type KillSwitchCloseInputs struct {
	...
	// HLHedgeCoins contains only hedge coins with a persisted, currently-held
	// hedge leg. The narrow roster prevents a kill switch from flattening a
	// foreign manual position on a merely configured-but-flat hedge coin.
