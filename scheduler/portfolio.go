...
type Position struct {
	...
	HedgeFor             string    `json:"hedge_for,omitempty"`               // #1159: primary coin this inverse hedge follows
	HedgePrimaryQtyBasis float64   `json:"hedge_primary_qty_basis,omitempty"` // #1159: primary quantity covered by the confirmed hedge fill
