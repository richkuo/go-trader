...
var strategyAuditReportData = strategyAuditReport{
	...
	Ranking: []auditRow{
		...
		{"range_scalper", "both", -0.38, -14.2, 34.4, true, -55.9, 9, "watch", "watch"},
		{"donchian_breakout", "both", -0.42, -17.6, 31.0, true, -55.5, 355, "watch", "watch"},
		{"ichimoku_cloud", "both", -0.43, -8.5, 40.1, true, -65.5, 173, "watch", "watch"},
		{"order_blocks", "both", -0.52, -19.9, 28.7, true, -63.4, 295, "watch", "watch"},
		{"amd_ifvg", "both", -0.53, -19.6, 28.9, true, -63.4, 87, "watch", "watch"},
		...
		{"session_breakout", "futures", -0.79, -28.4, 20.2, true, -67.3, 371, "watch", "watch (short leg unmeasured)"},
		...
		{"liquidity_sweeps", "both", -1.10, -42.0, 6.6, true, -63.0, 127, "watch", "watch (short leg unmeasured)"},
	...
	OOSNote: "Top-4 ordering is stable in and out of sample (BTC/USDT 1h, since 2026-01-01; B&H -30.4%): squeeze_momentum, breakout, momentum_pro, chart_pattern keep a 19-27pt edge over buy-and-hold in the unseen window. ichimoku_cloud's in-sample edge evaporates OOS and range_scalper underperforms holding — both stay watch with a downgrade bias.",
	Candidates: []candidateVerdict{
