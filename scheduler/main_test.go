...
func TestKnownSubcommandsMatchDispatch(t *testing.T) {
	expected := []string{"init", "export", "manual-open", "manual-add", "manual-close", "manual-cancel", "manual-update-sl", "manual-cancel-sl", "backfill", "probe", "inspect", "agent-info", "version"}
