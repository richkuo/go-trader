...
- Exit codes: probe 78, singleton 79, storage 80 = units' `RestartPreventExitStatus`. Ownership over ALL files (incl. `--once`) precedes migration/startup write; unit edits: `daemon-reload`.
