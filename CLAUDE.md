...
- `planHLCloseOrder`=SOLE size+mode of execute/manual close; refetch fail=defer unless uncapped `reduce_only`. Short fill books fill. rearm ONLY `resolveHLCloseRemainderStop`; Q=0 cancels unconfirmed SL/TP; unverified/unbacked/unplaced=ONE CRITICAL; `order_outcome`=SOLE outcome.
