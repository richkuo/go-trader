#!/usr/bin/env python3
"""Supplementary IS-window close-stack screens for #983 (README step 2).

Three screens beyond the #996 default grid (sweep_close_stacks.py), each
frozen-entry squeeze_momentum on the six audit datasets via the M1 harness
...
Run from repo root:
  uv run --no-sync python backtest/candidates/squeeze_983/sweep_supplementary.py \
      ...
      [--json backtest/candidates/squeeze_983/sweep2_is.json]
"""
