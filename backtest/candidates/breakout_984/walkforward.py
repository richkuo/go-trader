...
def main(argv=None):
    ...
    for symbol, tf in DATASETS:
        ...
        res = walk_forward_optimize(df, STRATEGY, frozen, n_splits=N_SPLITS, optimize_metric='dd_adjusted_return', symbol=symbol, timeframe=tf, registry='futures', close_stack_grid=grid, direction='long', verbose=False)
